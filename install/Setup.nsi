...
OutFile "..\bin\GDCL-MPEG4CodecSetup.exe"
...
Section "FilesInstall"
	...
	${if} ${RunningX64}
		...
		File "..\bin\x64\Release\mp4mux.dll"
		File "..\bin\x64\Release\mp4demux.dll"
	...
	File "..\bin\Win32\Release\mp4mux.dll"
	File "..\bin\Win32\Release\mp4demux.dll"
	ExecWait 'regsvr32.exe /s "$OUTDIR\mp4mux.dll"'
	ExecWait 'regsvr32.exe /s "$OUTDIR\mp4demux.dll"'
